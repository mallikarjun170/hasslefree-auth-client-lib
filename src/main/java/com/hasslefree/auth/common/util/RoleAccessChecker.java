 ...
 * Provides methods to verify user permissions and roles across microservices.
 */
public class RoleAccessChecker {
    ...
    /**
     * Check if the user has the minimum privilege level required.
     * Uses role hierarchy: ADMIN > OWNER > MANAGER > TENANT
     * 
     * @param context User authentication context
    ...
    /**
     * Check if the user is the same as the target user ID or has sufficient privileges.
     * Used for accessing user-specific resources.
     * 
     * @param context User authentication context
     ...
     */
    public static boolean canAccessUserResources(AuthenticationContext context, 
                                               String targetUserId, 
                                               UserRole minimumRoleOverride) {
     ...
     * @return true if user can access the target user's resources
     */
    public static boolean canAccessUserResourcesAsManager(AuthenticationContext context, String targetUserId) {
     ...
     * @return true if user can access the target user's resources
     */
    public static boolean canAccessUserResourcesAsOwner(AuthenticationContext context, String targetUserId) {
     ...
     */
    public static void logAccessDecision(AuthenticationContext context, 
                                       String resource, 
                                       String action, 
                                       boolean allowed) {
        if (context != null) {
            logger.info("Access {} for user {} ({}) to {} resource '{}' - Roles: {}", 
